...
void SetupEnemyGroups(void) {
    ...
    gMiscContainer = &enemy_groups_data[gBattleEnemyGroupId];
}
...
void sub_8F0EA64(u8 a1) {
    HandleControlCodes(gUnknown_08F29F00[a1]);
}
...
void sub_8F10E6C(void) {
    gMiscContainer = &gGameInfo.PlayerInfo.Struct.CharacterInfo[
