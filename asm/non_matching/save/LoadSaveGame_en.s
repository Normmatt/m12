...
_08F0D0E2:
	...
	str r2, [sp, #0x9c]
_08F0D0F0:
	ldr r0, _08F0D200 @ =gMSG_WindowClearTiles
...
_08F0D200: .4byte gMSG_WindowClearTiles
_08F0D204: .4byte 0x0000E9B0
_08F0D208: .4byte gMSG_OldGame
_08F0D20C: .4byte gUnknown_08F662EC
_08F0D210: .4byte gMSG_Speeds
_08F0D214:
	mov r1, sp
	add r1, r8
	movs r0, #0
...
_08F0D2DC:
	...
	mov r6, r8
	subs r6, #1
	ldr r5, _08F0D37C @ =gMSG_CopySave
	adds r4, r6, #0
	add r1, sp, #0x78
	ldr r3, [sp, #0xa8]
_08F0D2EC:
...
_08F0D31E:
	...
	cmp r0, #0
	beq _08F0D370
	ldr r0, _08F0D380 @ =gMSG_OverwriteSave
	bl HandleControlCodes
	adds r0, r4, #0
	mov r1, sb
	bl ReadSave
...
_08F0D370:
	...
	b _08F0D3D2
	.align 2, 0
_08F0D37C: .4byte gMSG_CopySave
_08F0D380: .4byte gMSG_OverwriteSave
_08F0D384:
	ldr r0, _08F0D3DC @ =gMSG_EraseSave
	bl HandleControlCodes
	mov r4, r8
	subs r4, #1
	adds r0, r4, #0
...
_08F0D3D2:
	...
	b _08F0D0E2
	.align 2, 0
_08F0D3DC: .4byte gMSG_EraseSave
_08F0D3E0:
	mov r0, r8
	subs r0, #1
	mov r1, sb
